...
public class VietjetBook {
	...
	public ArrayList<String > getDocumentJsoup(Response res){
		...
		list.add(viewstategen);
		return list;
	}
	public HashMap<String, String> createParamsLogin(final String viewstate,final String viewstategen,String user,String pass) throws Exception {	
		HashMap<String, String> params = new HashMap<String, String>();
		params.put("DebugID", "61");
		params.put("SesID", "25");
		params.put("__VIEWSTATE", viewstate);
		params.put("__VIEWSTATEGENERATOR", viewstategen);
		params.put("txtAgentID", user);
		params.put("txtAgentPswd", pass);
		return params;
	}

	private void createParams(HashMap<String, String> params,String button,final String viewstate,final String viewstategen){
		params.put("__VIEWSTATE", viewstate);
	...
	public HashMap<String, String> createPostMenuParams(final String viewstate,final String viewstategen) throws Exception {
		HashMap<String, String> params = new HashMap<String, String>();
		String button = "bookflight";
		createParams(params,button,viewstate,viewstategen);
		return params;
	}

	private void createSearchParams(HashMap<String, String> params,UpdateFarePriceCommand request,AirFareInfo fare1){
		params.put("lstCompanyList", "722ƒCTY VIET NHANH");
	...
	public HashMap<String, String> createSearchParams(UpdateFarePriceCommand request,final String viewstate,final String viewstategen) throws  VietJetBookException {
		try {			
			HashMap<String, String> params = new HashMap<String, String>();		
			String button = "vfto";
			createParams(params,button,viewstate,viewstategen);
	...
	public HashMap<String, String> createPostTravelParams(final String reference1,final String reference2,final String viewstate,final String viewstategen) throws  VietJetBookException {
		try {			
			HashMap<String, String> params = new HashMap<String, String>();
	...
	private void convertDetailParams(HashMap<String, String> params,AirPassengerInfo airPassengerInfo,int adt,int curINF,int countINF,ContactInfo contactInfo,AirPassengerInfo airPassengerInfoINF){
		...
		{
			params.put("chkPax"+adt+"_Infant", "on");
			params.put("txtPax"+adt+"_Infant_Name", airPassengerInfoINF.getLastName() + " "+ airPassengerInfoINF.getFirstName());
	...
	public HashMap<String, String> createPostDetailParams(List<AirPassengerInfo> passengerInfos,ContactInfo contactInfo,final String viewstate,final String viewstategen) throws  VietJetBookException {
		try {
			HashMap<String, String> params = new HashMap<String, String>();		
			String button = "continue";
			createParams(params,button,viewstate,viewstategen);
			...
			int curCHD = list.get(1).getQuantity();
			int curINF = list.get(2).getQuantity();
			int countINF = 0;
			AirPassengerInfo airPassengerInfo = passengerInfos.get(0);
			AirPassengerInfo airPassengerInfoINF = null;
			int infInfo = curADT + curCHD;
			if(curINF > 0){
				airPassengerInfoINF = passengerInfos.get(infInfo);
				infInfo++;
			}
			...
			if(airPassengerInfo.getPassengerType().toString().equals("ADT")){	
				int adt = 1;
				countINF++; // count = 1
				convertDetailParams(params,airPassengerInfo,adt,curINF,countINF,contactInfo,airPassengerInfoINF);
			}
			...
			if(passengerInfos.size() >= 2){
				...
				for(int i = 1;i < passengerInfos.size();i++){
					...
					if(curINF > 0 &&  infInfo < passengerInfos.size()){
						airPassengerInfoINF = passengerInfos.get(infInfo);
						infInfo++;
					}					
					if(airPassengerInfo.getPassengerType().toString().equals("ADT")){
	...
	public HashMap<String, String> createPostAddOnsParams2(final int RoundTrip, final int ADT_CHD,ArrayList<AirExtraService> extraServices,List<String> listAttrPasKg,List<String> listAttrPasKgBack,final int glagMeal,final String viewstate,final String viewstategen) throws  VietJetBookException {
		try {
			HashMap<String, String> params = new HashMap<String, String>();			
			String button = "continue";
			createParams(params,button,viewstate,viewstategen);
...
//					what += 28;
	...
	public HashMap<String, String> createPostAddOnsParams(final int RoundTrip, final int ADT_CHD,ArrayList<AirExtraService> extraServices,List<String> listAttrPasKg,List<String> listAttrPasKgBack,final int glagMeal,final String viewstate,final String viewstategen) throws  VietJetBookException {
		try {
			HashMap<String, String> params = new HashMap<String, String>();			
			String button = "continue";
			createParams(params,button,viewstate,viewstategen);
...
//						int back = list.get(1);
	...
	private void convertPaymentParams(HashMap<String, String> params){
		...
		params.put("dlstExpiry", "2015/02/28");
		params.put("txtCVC", "");
	...
	public HashMap<String, String> createPostPaymentsParams(final String viewstate,final String viewstategen) throws  VietJetBookException {
		try {
			HashMap<String, String> params = new HashMap<String, String>();		
			String button = "3rd";
			createParams(params,button,viewstate,viewstategen);
	...
	public HashMap<String, String> createPostConfirmParams(final String viewstate,AirItinerary itinerary,final String viewstategen) throws  VietJetBookException {
		try {
			HashMap<String, String> params = new HashMap<String, String>();		
			String button = "continue";
			createParams(params,button,viewstate,viewstategen);	
...
//			
			for(int i=1;i<=curADT+curCHD;i++){
				params.put("txtPax"+i+"_Gender", "F");
				AirPassengerInfo airPassengerInfo = passengerInfos.get(i-1);
				if(airPassengerInfo.getGender().toString().equals("MALE"))
					params.put("txtPax"+i+"_Gender", "M");
				params.put("txtPax"+i+"_LName", airPassengerInfo.getLastName());
				params.put("txtPax"+i+"_FName", airPassengerInfo.getFirstName());
			}
			
			for(int i=curADT+1;i<=curADT+curCHD;i++){
				params.put("txtPax"+i+"_Gender", "C");
			}
			int index = curADT+curCHD-1;
			for(int i = 1;i<=curINF;i++){
				AirPassengerInfo airPassengerInfo = passengerInfos.get(index);
				params.put("txtPax"+i+"_Infant_Name", airPassengerInfo.getLastName() + " " + airPassengerInfo.getFirstName());
			}
			
			params.put("ZeroOptions", "");
			params.put("chkIAgree", "on");
